  ...
  return (
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
            <div class="container px-0 px-lg-12" id="top">
                ...
                <a class="navbar-brand" href="#top"><img class="img-nav" src="logo2.png" alt="..."></img></a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item"><a class="nav-link" href="#step1">การนำเสนอ</a></li>
                        <li class="nav-item"><a class="nav-link" href="#step2">ผลงาน</a></li>
                        <li class="nav-item"><a class="nav-link" href="#price">ค่าลงทะเบียน</a></li>
                        <li class="nav-item"><a class="nav-link" href="#calendar">กำหนดการ</a></li>
